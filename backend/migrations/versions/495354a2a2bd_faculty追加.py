...
def upgrade():
    ...
    op.drop_constraint(
        op.f("departments_university_id_fkey"), "departments", type_="foreignkey"
    )
    op.create_foreign_key(
        None, "departments", "faculties", ["faculty_id"], ["faculty_id"]
    )
    ...
    op.drop_constraint(
        op.f("exam_results_uploaded_by_fkey"), "exam_results", type_="foreignkey"
    )
...
def downgrade():
    ...
    op.create_foreign_key(
        op.f("exam_results_uploaded_by_fkey"),
        "exam_results",
        "users",
        ["uploaded_by"],
        ["user_id"],
    ...
    op.add_column(
        "departments",
        sa.Column("faculty_name", sa.VARCHAR(), autoincrement=False, nullable=False),
    )
    op.add_column(
        "departments",
    ...
    op.create_foreign_key(
        op.f("departments_university_id_fkey"),
        "departments",
        "universities",
        ["university_id"],
        ["university_id"],
